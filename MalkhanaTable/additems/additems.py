...
def additems(prev_malkhana_frame):
    ...
    fir_no_entry.grid(row=1, column=1, padx=10, pady=10)
    seized_items_entry.grid(row=2, column=1, padx=10, pady=10)
    ipc_section_entry.grid(row=3, column=1, padx=10, pady=10)
    crime_location_entry.grid(row=4, column=1, padx=10, pady=10)
    crime_date_entry.grid(row=5, column=1, padx=10, pady=10)
    crime_witness_entry.grid(row=7, column=1, padx=10, pady=10)
    crime_inspector_entry.grid(row=8, column=1, padx=10, pady=10)
    description_of_items_entry.grid(row=10, column=1, padx=10, pady=10)
    where_kept_entry.grid(row=9, column=1, padx=10, pady=10)
